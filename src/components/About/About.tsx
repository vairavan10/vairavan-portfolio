...
import Vairavan from "../../assets/myself.png";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Vairavan, a passionate Product Developer dedicated to crafting seamless and engaging digital experiences. With expertise in HTML, CSS, JavaScript, and React
          </p>
        </ScrollAnimation>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.20 * 1000}>
          <img src={Vairavan} alt="Vinayak Singh" />
        </ScrollAnimation>
      </div>
    </Container>
  )
